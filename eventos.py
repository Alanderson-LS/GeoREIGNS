...
def demonio(jogador):
    ...
    while True:
        ...
        if resposta == "S":
            ...
            if dado == 1 or dado == 2:
                print(f"Ora, um {dado}, você tem bastante azar, HAHAHAHA")
                if dado == 1:
                ...
                print (f"Olha o que nós temos, {dado}, sua sorte e seu azar parece em equílibrio, nada mal")
                if dado == 3:
                ...
                print (f"O QUE?? UM {dado}??? Você tem bastante sorte, mas eu voltarei, e isso não se repetirá!")
                if dado == 5:
                    valor_1 = random.randint(15, 20)
                    valor_2 = random.randint(15, 20)
                    jogador.saude += valor_1
